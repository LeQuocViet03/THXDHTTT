...
<body>
    ...
    <nav class="nav-bar">
        <ul class="nav-menu">
            <li><a href="#" onclick="loadContent('thongtinSV')">Thông tin sinh viên</a></li>
            <li><a href="#" onclick="loadContent('thoikhoabieuSV')">Thời khóa biểu</a></li>
            <li><a href="#" onclick="loadContent('baocaoSV')">Gửi báo cáo</a></li>
            <li class="user-info">
